...
pkill -f "sing-box run -c /run/sb-tuic.json" 2>/dev/null
...
TUIC_URL="tuic://${TUIC_UUID}:${TUIC_PASSWORD}@${PUBLIC_IP}:${TUIC_PORT}?congestion_control=bbr&alpn=h3&udp_relay_mode=native&sni=${TUIC_SNI}&allowInsecure=1#${TUIC_ENCODED_NAME}"
